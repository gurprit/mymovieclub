...
function CreateList({ user }) {
  ...
  return (
    <div className="flex flex-col text-center w-full mb-12">
      <p className="lg:w-2/3 mx-auto mb-5 mt-12 leading-relaxed text-base">
        create a movie club
      </p>
      <div className="lg:w-2/6 mx-auto md:w-1/2 bg-gray-800 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 mb-10">
        <input
