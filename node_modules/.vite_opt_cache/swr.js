import React__default, { createContext, useContext, useRef, useState, useCallback, useMemo, useEffect, useLayoutEffect } from '@pika/react/source.development.js';
    ...
    var pages = useMemo(function () {
        ...
        for (var i = 0; i < pageCount; ++i) {
            if (!pageCache[i] ||
                ...
                pageCache[i] = {
                    component: (React__default.createElement(Page, { key: "page-" + pageOffsets[i] + "-" + i, offset: pageOffsets[i], withSWR: getWithSWR(i) })),
                    pageFn: _pageFn,
